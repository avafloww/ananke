...
What ananke predicts a llama.cpp service will hold, and how each term was
arrived at. The code is `crates/estimate/`; this is the model those functions
implement.

The tuned constants themselves live in `crates/tuning/tuning.json`, each with
