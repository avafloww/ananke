//! Tests for [`crate::spawn::llama_cpp::render_llama_cpp_argv`] / [`crate::spawn::llama_cpp`]'s flag rendering,
//! exercised end-to-end through [`crate::spawn::render_argv`].

use std::{collections::BTreeMap, path::PathBuf};

use ananke_allocator::placement::CommandArgs;
use ananke_config::validate::{
    DeviceSlot, GenerationStallTrigger, Lifecycle, NumaStrategy, PlacementPolicy, ServiceConfig,
    SplitMode,
...
fn renders_ik_runtime_flags() {
    use ananke_config::{IkSettings, RuntimeConfig};
...
fn an_operator_supplied_cache_ram_is_not_duplicated() {
    ...
    assert_eq!(
        cache_ram_from_extra_args(&svc.extra_args),
        Some(0),
