...
//! its own base — see [`ananke_tracking::rolling`] for why a single mean over
...
use ananke_allocator::placement::RollingInputs;
use ananke_tracking::rolling::MemoryClass;
use tracing::debug;
...
mod tests {
    ...
    use ananke_tracking::rolling::{MIN_TRUSTED_SAMPLES, MemoryClass, RollingTable};
