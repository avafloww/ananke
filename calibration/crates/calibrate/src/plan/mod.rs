...
pub const QUESTIONS: &[(&str, Sweep)] = &[
    ...
    ("draft-curve", phases::draft_curve),
    ("draft-slots", phases::draft_slots),
    ("concurrency-curve", phases::concurrency_curve),
    ("mmproj-curve", phases::mmproj_curve),
    ("flash-attn-curve", phases::flash_attn_curve),
    ("fork", phases::fork),
