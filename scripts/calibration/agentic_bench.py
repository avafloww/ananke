...
Vendored from the `llama-cpp-model-tuning` skill so that calibration is
reproducible from this repository alone: the skill lives outside the tree and
may not be present on a machine that needs to re-derive a constant. Keep the
